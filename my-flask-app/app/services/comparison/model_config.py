...
DEFAULT_COMPARISON_PRO_MODEL_ID = "gemini-3.1-pro-preview"
DEFAULT_COMPARISON_SAFE_MODEL_ID = "gemini-3.5-flash"
...
SDK_SUPPORTED_COMPARISON_MODEL_IDS: Set[str] = {
    ...
    DEFAULT_COMPARISON_SAFE_MODEL_ID,
...
def comparison_stage_a_model_id() -> str:
    return _configured_model("COMPARISON_STAGE_A_MODEL", DEFAULT_COMPARISON_PRO_MODEL_ID)


def comparison_stage_a_repair_model_id() -> str:
    return _configured_model("COMPARISON_STAGE_A_REPAIR_MODEL", DEFAULT_COMPARISON_PRO_MODEL_ID)


def comparison_stage_b_model_id() -> str:
    return _configured_model("COMPARISON_STAGE_B_MODEL", DEFAULT_COMPARISON_PRO_MODEL_ID)


def comparison_safe_model_id() -> str:
    return normalize_model_id(
        os.environ.get(
            "COMPARISON_SAFE_MODEL",
            os.environ.get("GEMINI_COMPARE_SAFE_MODEL_ID", DEFAULT_COMPARISON_SAFE_MODEL_ID),
        )
    )
